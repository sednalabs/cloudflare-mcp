...
version-2 row-set proof, require its reviewed column to be nullable, and reject
every contradictory storage-class/value pairing. The v2 assertion ID remains

...
pub const TOOL_DISCOVERY: &[ToolDiscoveryEntry] = &[
    ...
    ToolDiscoveryEntry {
        ...
        group: "d1",
        read_only: false,
        description: "Preview and admit one exact local-file D1 import under stable inventory and durable handoff custody.",
        keywords: &[
            "d1",
            "database",
            "import",
    ...
    ToolDiscoveryEntry {
        ...
        group: "d1",
        read_only: true,
        description: "Read back one exact D1 SQL-file import admission binding without mutation.",
        keywords: &[
            "d1",
            "database",
            "import",
    ...
    ToolDiscoveryEntry {
        ...
        group: "d1",
        read_only: false,
        description: "Preview or execute one approved local SQL-file D1 import under durable custody.",
        keywords: &[
            "d1", "database", "import", "sql", "file", "upload", "ingest", "custody", "mutate",
        ],
    },
    ToolDiscoveryEntry {
        ...
        group: "d1",
        read_only: true,
        description: "Resume only safe polling or read back the terminal receipt for one retained D1 SQL-file import.",
        keywords: &[
            "d1",
            "database",
            "import",
    ...
    ToolDiscoveryEntry {
        ...
        group: "d1",
        read_only: false,
        description: "Bootstrap only the canonical empty Wrangler-compatible migration ledger on an independently selected empty D1 target under an approved plan.",
        keywords: &[
            "d1",
            "database",
            "migration",
    ...
    ToolDiscoveryEntry {
        ...
        group: "d1",
        read_only: true,
        description: "Build stable read-only terminal evidence for one exact retained migration-ledger bootstrap without retrying its initializer.",
        keywords: &[
            "d1",
            "database",
            "migration",
    ...
    ToolDiscoveryEntry {
        ...
        group: "d1",
        read_only: false,
        description: "Persist an approved bootstrap terminal receipt and retire exactly re-proven retained bootstrap custody without provider writes.",
        keywords: &[
            "d1",
            "database",
            "migration",
    ...
    ToolDiscoveryEntry {
        ...
        group: "d1",
        read_only: false,
        description: "Terminally retire exact marker-aware bootstrap custody only when durable local evidence proves the initializer was never dispatched.",
        keywords: &[
            "d1",
            "database",
            "migration",
    ...
    ToolDiscoveryEntry {
        ...
        group: "d1",
        read_only: true,
        description: "Build stable read-only reconciliation evidence for one retained exact-byte D1 migration manifest.",
        keywords: &[
            "d1",
            "database",
            "migration",
    ...
    ToolDiscoveryEntry {
        ...
        group: "d1",
        read_only: false,
        description: "Persist an approved terminal reconciliation receipt and retire one exactly re-proven retained D1 migration lease.",
        keywords: &[
            "d1",
            "database",
            "migration",

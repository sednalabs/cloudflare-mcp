...
pub const TOOL_DISCOVERY: &[ToolDiscoveryEntry] = &[
    ...
    ToolDiscoveryEntry {
        ...
        group: "workers",
        read_only: true,
        description: "Capture stable bounded Worker versions, exact sanitized detail, and two-pass deployment evidence.",
        keywords: &[
            "worker",
            "workers",
            "version",
    ...
    ToolDiscoveryEntry {
        ...
        group: "workers",
        read_only: false,
        description: "Upload one disabled Worker version with strict exact-base inheritance and non-retrying proof.",
        keywords: &[
            "worker",
            "workers",
            "version",
    ...
    ToolDiscoveryEntry {
        ...
        group: "workers",
        read_only: true,
        description: "Reconcile an ambiguous Worker version upload against a pinned pre-upload snapshot without another write.",
        keywords: &[
            "worker",
            "workers",
            "version",
